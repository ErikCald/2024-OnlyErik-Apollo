...
public class ApolloContainer extends RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        // that also controls the arm, intake, shooter
        ...
        // driver.rightTrigger().whileTrue(new SelectByAllianceCommand( // Implement command group
        // that also controls the arm, intake, shooter
        //   PhotonSubsystem.getInstance().getAprilTagCommand(PhotonPositions.RIGHT_SPEAKER_BLUE,
        // driver),
