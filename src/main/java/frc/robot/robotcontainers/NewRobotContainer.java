...
public class NewRobotContainer extends RobotContainer {
    ...
    public NewRobotContainer() {
        ...
        s_Swerve.setDefaultCommand(new TeleopSwerve(s_Swerve, driver, TeleopSpeeds.MAX));
     ...
     * {@link CommandXboxController} or other ways.
     */
        ...
        driver.b()
                .onTrue(
                        SwerveSubsystem.getInstance()
                                .setOdometryCommand(new Pose2d(3, 3, new Rotation2d(0))));
        driver.a()
                .whileTrue(
                        PhotonSubsystem.getInstance()
                                .getWaitForDataCommand(6)
                                .andThen(
                                        new PhotonMoveToTarget(
                                                new Translation2d(2, 0), new Rotation2d(0), 0.2)));

        driver.leftBumper().whileTrue(new TeleopSwerve(s_Swerve, driver, TeleopSpeeds.SLOW));
        /* Operator Controls */
    }
