...
public class Robot extends TimedRobot {
    ...
    private void createRobotContainer() {
        ...
        switch (Config.getRobotId()) {
            ...
            case 3:
                m_robotContainer = new CosmobotContainer();
                break;
                ...
                DriverStation.reportError(
                        String.format(
                                "ISSUE WITH CONSTRUCTING THE ROBOT CONTAINER. \n "
                                        + "PoseidonContainer constructed by default. RobotID: %d",
                                Config.getRobotId()),
                        true);
                break;
        }
        // Add CommandScheduler to shuffleboard so we can display what commands are
        // scheduled
