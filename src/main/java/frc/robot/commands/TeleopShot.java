 ...
 */
public class TeleopShot extends SequentialCommandGroup {
    private final BooleanSupplier m_isButtonPressed;
    private final ArmSetpoint m_armSetpoint;
    private final ShooterSetpoint m_shooterSetpoint;
    ...
    public TeleopShot(
        ...
        Command runAlways =
                Commands.parallel(
                        shooter.spinCommand(m_shooterSetpoint), arm.moveCommand(m_armSetpoint));
    ...
    public boolean shouldShoot() {
        return m_isButtonPressed.getAsBoolean()
                && shooter.isAtSetpoint(m_shooterSetpoint)
                && arm.isAtSetpoint(m_armSetpoint);
    }
}
