...
public class RotateAngleToVisionSupplier extends TeleopSwerve {
    ...
    public RotateAngleToVisionSupplier(
            CommandXboxController driver, String photonvisionCameraName) {
        super(driver);
    ...
    protected double calculateRotationVal() {
        m_setpoint =
                SwerveSubsystem.getInstance().getHeading().getRadians() + m_supplier.getAsDouble();
