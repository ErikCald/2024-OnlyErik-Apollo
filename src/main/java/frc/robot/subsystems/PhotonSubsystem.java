...
public class PhotonSubsystem extends SubsystemBase {
    ...
    // constants
    private double[] APRIL_HEIGHTS = {
        0, 0, 0, 0, 0, 1.32, 1.32, 0, 0, 0, 0, 1.31, 1.31, 1.31, 1.31, 1.31, 1.31
    };
    ...
    private Pose2d cameraOffset =
            new Pose2d(new Translation2d(0.23, 0.3), Rotation2d.fromDegrees(0));
    // networkTableName
    ...
    public void periodic() {
        ...
        if (result.hasTargets()) {
            ...
            Optional<Pose2d> optPose =
                    SwerveSubsystem.getInstance().getPoseAtTimestamp(result.getTimestampSeconds());
