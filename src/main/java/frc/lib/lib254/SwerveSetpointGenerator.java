 ...
 * This version of SwerveSetpointGenerator.java from Team 264 is modified by FRC Team 6328
 * Mechanical Advantage and slightly modified by FRC Team 2706 Merge Robotics.
 *
...
public class SwerveSetpointGenerator {
    ...
    /*
     * SwewrvSetpointGenerator generates a new setpoint that respects all of the kinematic constraints on
     * module rotation speed and wheel velocity/acceleration.
     *
     * @param kinematics The kinematics object representing the robot's swerve drive.
     * @param moduleLocations The locations of the modules on the robot as fed into SwerveDriveKinematics.
     */
    public SwerveSetpointGenerator(SwerveDriveKinematics kinematics, Translation2d[] modLocations) {
        this.kinematics = kinematics;
        this.moduleLocations = modLocations;
    }

    /**
     * Converts ChassisSpeeds to a Twist2d object.
     * Utility function for SwerveSetpointGenerator written by 6328.
     *
     * @param speeds The ChassisSpeeds object to convert.
     * @return The converted Twist2d object.
     */
    private static Twist2d toTwist2d(ChassisSpeeds speeds) {
        return new Twist2d(
                speeds.vxMetersPerSecond, speeds.vyMetersPerSecond, speeds.omegaRadiansPerSecond);
    }

    /**
     * Checks if two double values are approximately equal within a default epsilon of 1e-9.
     * Utility function for SwerveSetpointGenerator written by 6328.
     *
    ...
    /**
     * Checks if two double values are approximately equal within a given epsilon.
     * Utility function for SwerveSetpointGenerator written by 6328.
     *
     * @param a       the first double value
     * @param b       the second double value
    ...
    /**
     * Checks if two Twist2d objects are approximately equal within a default epsilon of 1e-9.
     * Utility function for SwerveSetpointGenerator by 6328.
     *
     * @param twist the first Twist2d object
     * @param other the second Twist2d object
     * @return true if the two objects are approximately equal, false otherwise
     */
    private static boolean epsilonEquals(Twist2d twist, Twist2d other) {
    ...
    public SwerveSetpoint generateSetpoint(
            final SwerveModuleLimits limits,
