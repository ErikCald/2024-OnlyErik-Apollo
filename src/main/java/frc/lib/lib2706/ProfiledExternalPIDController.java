 ...
 *
 * <p>This is a modified version of the {@link edu.wpi.first.math.controller.ProfiledPIDController}
 * from WPILib to export the PIDController to an external device like the CANSparkMax or other motor
 * controllers.
 */
