...
public class UpdateSimpleFeedforward {
    ...
    /**
     * Create a UpdateFeedforward to update a {@link SimpleMotorFeedforward} object from
     * networktables.
     *
     * @param setFeedforward A consumer to recieve an updated SimpleMotorFeedforward. Recommend:
     *     {@snippet (ff) -> m_topFF = ff}
